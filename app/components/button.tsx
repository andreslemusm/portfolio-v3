...
type BaseProps = { variant?: keyof typeof variantStyles }

type ButtonProps = { as?: "button" } & React.ComponentPropsWithoutRef<"button">

type AnchorProps = { as: "anchor" } & Omit<
  React.ComponentPropsWithoutRef<"a">,
  "type"
>

type LinkProps = { as: "link" } & Omit<
...
export const Button = ({
  ...
  const calculatedClassName = clsx(
    "inline-flex items-center justify-center gap-2 rounded-md px-3 py-2 text-sm outline-offset-2 transition-colors active:transition-none",
