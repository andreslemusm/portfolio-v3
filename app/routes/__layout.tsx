...
import { FaChevronDown, FaMoon, FaSun, FaTimes } from "react-icons/fa";
              ...
              <div className="relative flex gap-4">
                        ...
                        >
                          <div className="flex flex-row-reverse items-center justify-between">
                            <Popover.Button
                              ...
                              className="-m-1 p-1"
                            >
                              <FaTimes className="h-6 w-6 text-zinc-500 dark:text-zinc-400" />
                            </Popover.Button>
                ...
                <div className="flex justify-end md:flex-1">
                  <div className="pointer-events-auto">
                    ...
                    >
                      <FaSun className="h-5 w-5 fill-teal-400 transition group-hover:fill-teal-500 dark:hidden" />
                      <FaMoon className="hidden h-5 w-5 fill-zinc-700 transition group-hover:fill-zinc-500 dark:block" />
                    </button>
                  </div>
                </div>
              </div>
